...
export function CollageSection() {
  return (
    <section className="relative overflow-hidden px-6 py-16 md:px-20 md:py-24">
      ...
      <div className="relative mx-auto flex h-[clamp(28rem,55vw,46rem)] items-start justify-center ">
        {PHOTOS.map((photo, i) => (
          <div
            key={i}
      ...
      {/* overlay headline */}
      <h2 className="pointer-events-none absolute inset-x-0 top-1/2 z-30 -translate-y-1/2 text-center text-[clamp(2.5rem,7vw,5.5rem)] font-bold text-beige drop-shadow-[0_2px_14px_rgba(0,0,0,0.5)]">
